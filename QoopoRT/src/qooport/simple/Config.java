...
public class Config extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("4100");

        jLabel3.setText("Auxiliar:");

        jTextField2.setText("4101");

        jLabel4.setText("Es el puerto principal de conexión");

        jLabel5.setText("Es el puerto usado para la transferencias.");

        jLabel6.setText("Si va a usar conexión  a internet aségurese de abrir los puertos en el router.");
        ...
        jLabel7.setText("Claves");

        jLabel8.setText("Longitud clave aleatoria:");

        jTextField3.setText("6");

        jLabel9.setText("Acceso no presencial");
