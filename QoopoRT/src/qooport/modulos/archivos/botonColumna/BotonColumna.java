 ...
 */
/**
 * The BotonColumna class provides a renderer and an editor that looks like a
 ...
 *
 */
public class BotonColumna extends AbstractCellEditor
     ...
     */
    public BotonColumna(JTable table, Action action, int column, String toolTip) {
        this.table = table;
        this.action = action;
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        ...
        } else if (value instanceof ValorBotonColumna) { //<ag>18/01/2017
            ValorBotonColumna valor = (ValorBotonColumna) value;
            editButton.setText(valor.getTexto());
            editButton.setIcon(valor.getIcono());
            editButton.setEnabled(valor.isActivo());
        } else {
...
//		renderButton.setText( (value == null) ? "" : value.toString() );
        if (value == null) {
            ...
            ValorBotonColumna valor = (ValorBotonColumna) value;
            renderButton.setText(valor.getTexto());
            renderButton.setIcon(valor.getIcono());
            renderButton.setEnabled(valor.isActivo());
        } else {
