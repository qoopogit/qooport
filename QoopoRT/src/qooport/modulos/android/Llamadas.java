...
public class Llamadas extends JFrame {
    ...
    public Llamadas(Asociado servidor) {
        initComponents();
...
//        setTitle("Administrador de Archivos");
        try {
            setTitle("Llamadas [" + servidor.getInformacion() + "]");
        } catch (Exception e) {
            setTitle("Llamadas");
        }
...
//        this.btnIniciarDetener.setText("Parar");
        ...
        this.eliminar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                Llamadas.this.eliminarActionPerformed(evt);
            }
        });
        ...
        this.crearCarpeta.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                Llamadas.this.crearCarpetaActionPerformed(evt);
            }
        });
        ...
        this.tabla.setModel(new DefaultTableModel(
                new Object[0][],
                new String[]{"id", "Hilo", "add", "Persona", "fecha", "lectura", "cuerpo", "tipo"}) {
...
//                Contactos.this.tablaMouseClick(evt);
            ...
            public void mousePressed(MouseEvent evt) {
                Llamadas.this.tablaMousePressed(evt);
            }
        });
...
//        vistaPrevia.setSize(150, 150);
        vistaPrevia.setIcon(Util.cargarIcono16("/resources/llamadaGrande.png"));
