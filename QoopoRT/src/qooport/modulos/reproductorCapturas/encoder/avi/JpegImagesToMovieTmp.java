...
/*
 * @(#)JpegImagesToMovieTmp.java	1.3 01/03/13
 *
 ...
 * QuickTime movie.
 */
public class JpegImagesToMovieTmp implements ControllerListener, DataSinkListener {
    ...
    public static void main(String args[]) {
        ...
        JpegImagesToMovieTmp imageToMovie = new JpegImagesToMovieTmp();
