...
//        try {
//            BufferedImage imgDiferencia = obtenerCambios(anterior, imagen);
//            lista = new ArrayList<PantallaBloque>();
//            if (opciones.getTipoDatos() == 1) {
//                byte[] datos;
//                if (porDiferencia > 90) {
//                    datos = obtenerBytes(imgDiferencia);//solo es es la imagen completa comprimo en jpg (primer envio)
//                } else {
//                    datos = obtenerBytes(imgDiferencia, 1);// le mando con calidad 100% (sincompresion jpg) para q no se ensucie la imagen
//                }
//                lista.add(new PantallaBloque("", 0, 0, imagen.getWidth(), imagen.getHeight(), datos));
////                lista.add(new PantallaBloque("", 0, 0, imagen.getWidth(), imagen.getHeight(), obtenerBytes(diferencia)));
//            } else {
//                lista.add(new PantallaBloque("", 0, 0, imagen.getWidth(), imagen.getHeight(), obtenerInts(imgDiferencia)));
//            }
//            //anterior = imagen;
