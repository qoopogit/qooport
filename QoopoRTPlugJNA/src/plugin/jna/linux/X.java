 ...
 * <p/>
 * Some code segments in this class are based on the code of the program wmctrl
 * (licensed under GPLv2) written by Tomas Styblo &lt;tripie@cpan.org&gt;.
 * Thanks a lot, Tomas!
 *
...
public class X {
    ...
    public static class Display {
        ...
        /**
         * Returns the key name corresponding to the keycode and the index in
         * the keycode vector.
         *
         * @param keyCode keycode
    ...
    /**
     * Modifier keymap. The lists shift, lock, control, mod1, mod1, mod1, mod1,
     * mod1 contain the keycodes as Byte objects. You can directly access these
     * lists to read, replace, remove or insert new keycodes to these modifiers.
    ...
    public static class ModifierKeymap {
        ...
        /**
         * Creates a modifier keymap and reads the modifiers from the
         * XModifierKeymap.
         *
    ...
    public static class Window {
         ...
         * @param xa_prop_type property type
         * @param xa_prop_name property name
         * @return property value as a null terminated byte array, or null if
         * not found
         * @throws X11Exception thrown if X11 window errors occurred
         */
        ...
        /**
         * Returns the property value as byte array where every '\0' character
         * is replaced by '.'.
         *
         * @param xa_prop_type property type
         * @param xa_prop_name property name
         * @return property value as byte array where every '\0' character is
         * replaced by '.'. null if the property was not found
         * @throws X11Exception thrown if X11 window errors occurred
         */
        ...
        /**
         * Returns the property value as string where every '\0' character is
         * replaced by '.'.
         *
         * @param xa_prop_type property type
         * @param xa_prop_name property name
         * @return property value as string where every '\0' character is
         * replaced by '.'
         * @throws X11Exception thrown if X11 window errors occurred
         */
         ...
         * @param xa_prop_type property type
         * @param xa_prop_name property name
         * @return property value as string list, or null if the property value
         * does not exist
         * @throws X11Exception thrown if X11 window errors occurred
         */
        ...
        /**
         * Returns the property value as UTF8 string where every '\0' character
         * is replaced by '.'.
         *
         * @param xa_prop_type property type
         * @param xa_prop_name property name
         * @return property value as UTF8 string where every '\0' character is
         * replaced by '.'
         * @throws X11Exception thrown if X11 window errors occurred
         */
