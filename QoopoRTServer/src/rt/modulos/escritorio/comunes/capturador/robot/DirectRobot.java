 ...
 */
package rt.modulos.escritorio.comunes.capturador.robot;
...
//            System.out.println();
    ...
    public int[] getRGBPixels2(Rectangle bounds) {
        int[] pixeles = new int[bounds.width * bounds.height];
        getRGBPixels(bounds.x, bounds.y, bounds.width, bounds.height, pixeles);
        return pixeles;
    }
        ...
        if (getRGBPixelsMethod != null) {
            try {
                switch (getRGBPixelsMethodType) {
                    case 0:
                        getRGBPixelsMethod.invoke(peer, new Object[]{x, y, width, height, pixels});
                        break;
                    case 1:
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        getRGBPixelsMethod.invoke(peer, new Object[]{getRGBPixelsMethodParam, x, y, width, height, pixels});
                        break;
                }
                return true;
            } catch (Exception ex) {
